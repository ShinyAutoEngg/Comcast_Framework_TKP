...
public class BaseClass_mavenParamAndPropFile {
	...
	{
		/*passing a second argument | If parameters are not passed from maven
		 * cmd line System.getProperty() will receive from properties file
		*/
